...
class NoteImage(models.Model):
    ...
    note = models.ForeignKey('website.Note', on_delete=models.CASCADE, related_name='note_images')  # Обновлен related_name
...
class Task(models.Model):
    ...
    task_type = models.ForeignKey(TaskType, on_delete=models.CASCADE, blank=True, null=True, verbose_name="Task Choice")
